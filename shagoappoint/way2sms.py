...
class Sms:
    ...
    def __init__(self, mobileNo, password):
        ...
        self.jsid = self.session.cookies.get_dict()['JSESSIONID'][
    ...
    def send(self, mobile_no, msg):
        ...
        if len(msg) > 139 or len(
                mobile_no) != 10 or not mobile_no.isdecimal():  # checks whether the given message is of length more than 139 and mobile numnber is valid
            return False
